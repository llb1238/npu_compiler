#include "../../backend/AsmInst/instruction.h"
#include "../../backend/hardware/HardwareManager.h"
#include <cassert>
...
{
    auto type = inst.Op;
    string rd = RegisterManager::regs[inst.rd], rs1 = RegisterManager::regs[inst.rs1],
           rs2 = RegisterManager::regs[inst.rs2];
    string frd = RegisterManager::fregs[inst.frd], frs1 = RegisterManager::fregs[inst.frs1],
           frs2 = RegisterManager::fregs[inst.frs2];
    switch (type) {
        case RISCV_ADD:
            os << "\t" << "add " << rd << ", " << rs1 << ", " << rs2;
            break;
